...
module.exports = (function () {
    ...
    var response = require('./response.js'),
        stream = require('../stream/streams.js'),
    ...
    Parser.prototype.occ = function(occurrence) {
        ...
        return self.then(self.occ(occurrence-1)).map(function(c) {
    ...
    // (unit -> Parser 'a 'c) -> Parser 'a 'c
    function lazy(p) {
        return new Parser(function(input,index) {
            return p().parse(input,index);
        });        
    }
    ...
    return {
        ...
        any : satisfy(function () { return true; })
    };
