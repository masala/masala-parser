...
module.exports = (function () {
    ...
    Accept.prototype.isAccepted = function () {
        return true;
    };
    
    // Response 'a 'c => unit -> bool
    Accept.prototype.toTry = function () {
        return atry.success(this.value); 
    };
    ...
    // Response 'a 'c => unit -> bool
    Reject.prototype.isAccepted = function () {
        return false;
    };
    
    // Response 'a 'c => unit -> bool
    Reject.prototype.toTry = function () {
        return atry.failure(new Error("parser error at " + this.offset)) ; 
    };
