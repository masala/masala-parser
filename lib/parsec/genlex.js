...
module.exports = (function () {
    ...
    Genlex.prototype.space = function() {
        return parser.satisfy(function (a) {
            return " \r\n\f\t".indexOf(a) >= 0;
        });
    };
    ...
    Genlex.prototype.ident = function (f) {
        ...
        return parser.letter().then(idletter.optrep()).map(function(r) {
    ...
    Genlex.prototype.tokens = function (f) {
        return this.spaces().thenRight(this.token(f)).thenLeft(this.spaces()).optrep().thenLeft(parser.eos());
    };
