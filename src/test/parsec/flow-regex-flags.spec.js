...
describe('F.regex – behaviour of individual RegExp flags', () => {
    ...
    it('u flag → \\u{…} escape recognised / no-u flag → fails', () => {
        ...
        // with u
        let stream = Streams.ofChar(smile)
