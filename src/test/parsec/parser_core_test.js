...
export default {
  ...
  'expect (thenLeft) to return a': function(test) {
    ...
    // tests here
    test.deepEqual(
      C.char('a').thenLeft(C.char('b')).parse(stream.ofString('ab'), 0).value,
      'a',
      'should be accepted.'
    );
    test.done();
  ...
  'expect (thenRight) to return a': function(test) {
    ...
    // tests here
    test.deepEqual(
      C.char('a').thenRight(C.char('b')).parse(stream.ofString('ab'), 0).value,
      'b',
      'should be accepted.'
    );
    test.done();
  ...
  'expect (thenReturns) to be accepted': function(test) {
    ...
    // tests here
    test.equal(
      C.char('a').thenReturns('b').parse(stream.ofString('ab'), 0).isAccepted(),
      true,
      'should be accepted.'
    );
    test.done();
  ...
  'expect (thenReturns) to be rejected': function(test) {
    ...
    // tests here
    test.equal(
      C.char('a').thenReturns('b').parse(stream.ofString('b'), 0).isAccepted(),
      false,
      'should be rejected.'
    );
    test.done();
  ...
  'expect (or) to be accepted': function(test) {
    ...
    // tests here
    test.equal(
      C.char('a').or(C.char('b')).parse(stream.ofString('a'), 0).isAccepted(),
      true,
      'should be accepted.'
    );
    test.done();
  ...
  'expect (or) to be rejected': function(test) {
    ...
    // tests here
    test.equal(
      C.char('a').or(C.char('b')).parse(stream.ofString('c'), 0).isAccepted(),
      false,
      'should be rejected.'
    );
    test.done();
  ...
  'expect (rep) mutiple to return [a,a,a,a]': function(test) {
    ...
    // tests here
    test.deepEqual(
      C.char('a').rep().parse(stream.ofString('aaaabbb'), 0).value.array(),
      ['a', 'a', 'a', 'a'],
      'should be accepted.'
    );
    test.done();
  ...
  'expect (optrep) mutiple to accepted': function(test) {
    ...
    // tests here
    test.deepEqual(
      C.char('a').optrep().parse(stream.ofString('aaaabbb'), 0).isAccepted(),
      true,
      'should be accepted.'
    );
    test.done();
  ...
  'expect (optrep) mutiple to return some [a,a,a,a]': function(test) {
    ...
    // tests here
    test.deepEqual(
      C.char('a').optrep().parse(stream.ofString('aaaabbb'), 0).value.array(),
      ['a', 'a', 'a', 'a'],
      'should be accepted.'
    );
    test.done();
  ...
  'expect (optrep) to return [b,b,b]': function(test) {
    ...
    // tests here
    test.deepEqual(
      C.notChar('a').optrep().parse(stream.ofString('bbba'), 0).value.array(),
      ['b', 'b', 'b'],
      'should be accepted.'
    );
    test.done();
