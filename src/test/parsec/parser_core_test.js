...
export default  {
  ...
  'expect (rep) mutiple to return [a,a,a,a]': function(test) {
    test.expect(1);
    // tests here
    test.deepEqual(C.char("a").rep().parse(stream.ofString("aaaabbb"),0).value.array(),
                   ['a','a','a','a'],
                   'should be accepted.');
    test.done();
  },
  ...
  'expect (optrep) mutiple to return some [a,a,a,a]': function(test) {
    test.expect(1);
    // tests here
    test.deepEqual(C.char("a").optrep().parse(stream.ofString("aaaabbb"),0).value.array(),
                   ['a','a','a','a'],
                   'should be accepted.');
    test.done();
  },
  ...
  'expect (optrep) to return none': function(test) {
    test.expect(1);
    // tests here
    test.deepEqual(C.char("a").optrep().parse(stream.ofString("bbb"),0).value.array(),
                   [],
                   'should be accepted.');
    test.done();
  },
  ...
  'expect (optrep) to return [b,b,b]': function(test) {
    test.expect(1);
    // tests here
    test.deepEqual(C.notChar("a").optrep().parse(stream.ofString("bbba"),0).value.array(),
                   ['b','b','b'],
                   'should be accepted.');
    test.done();
  },
  ...
  'expect two (optrep) to return [[b,b,b],[a]]': function(test) {
    test.expect(1);
    // tests here
    test.deepEqual(C.char("b").optrep().then(C.char("a").optrep()).
  ...
  'expect two (rep) to return [[b,b,b],[a]]': function(test) {
    test.expect(1);
    // tests here
    test.deepEqual(C.char("b").rep().then(C.char("a").rep()).
                      map(r => r.map((e) => e.array())).
                      parse(stream.ofString("bbba"),0).value,
                       [['b','b','b'],['a']],
                       'should be accepted.');
