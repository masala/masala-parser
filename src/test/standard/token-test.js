...
export default {
    ...
    'test eol should be found': function(test){
        ...
        testParser(C.string('Hello').then(T.eol).then(C.string('World')).then(F.eos) , testString);
        test.ok(accepted);
        test.done();
    },
    ...
    'test blanks': function(test){
        ...
        testParser(C.string('Hello').then(T.blank()).then(C.string('World')).then(F.eos) , testString);
        test.ok(accepted);
        test.done();
    },
    'test more blanks': function(test){
        const testString = 'Hello\t\n  World';
        testParser(C.string('Hello').then(T.blank(' \t\n')).then(C.string('World')).then(F.eos) , testString);
        test.ok(accepted);
        test.done();
    },
