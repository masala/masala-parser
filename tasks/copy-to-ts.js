...
deleteSources().then(deleteBuild).then(copy).catch(displayError)
...
function deleteSources() {
    return rmfr('./integration-ts/node_modules/@masala/parser/src').then(() =>
        rmfr('./integration-npm/node_modules/@masala/parser/src'),
    )
}
...
const destinations = [
    ...
    './demo/node_modules/@masala/parser',
]
